...
export default function AddToCart({ price, reduction, oldPrice, setCart }) {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <button
        className="w-full bg-orange-500 rounded-lg flex justify-center items-center h-12 mb-6 hover:bg-orange-300 sm:mt-6"
        onClick={() => nbItems && setCart(nbItems, totalPrice, totalOldPrice)}
      >
